...
PRODUCT_NAMES = [
	...
	"Мышь", "Монитор", "Веб-камера", "Микрофон", "Колонки",
	"Роутер", "Кабель USB", "Зарядное устройство", "Чехол", "Защитное стекло",
	"Флешка", "Внешний диск", "SSD накопитель", "Оперативная память", "Видеокарта",
	"Процессор", "Материнская плата", "Блок питания", "Корпус ПК", "Кулер",
	"Термопаста", "Коврик для мыши", "Игровое кресло", "Стол компьютерный", "Лампа настольная"
]

ADJECTIVES = [
	"Профессиональный", "Игровой", "Беспроводной", "Компактный", "Мощный",
	"Стильный", "Эргономичный", "Премиум", "Бюджетный", "Универсальный",
	"Портативный", "Надежный", "Современный", "Классический", "Инновационный"
]
