...
- **Критерии**: удобно и быстро (явная передача, без привязки к cookie); риск подделки ID выше, чем у server-side session cookie, но для MVP приемлемо оставить UUID v4, кроме того, в гостевой корзине нет чувствительных данных.
