...
from schemas.product import ProductShortListResponse, ProductFilterParams
    ...
    def __init__(
        ...
        if filter:
            try:
                ...
                self.params = ProductFilterParams.model_validate(parsed_json)
            except Exception:
...
async def get_product_list_api(
    ...
    filter_extractor: JsonFilterExtractor = fastapi.Depends(),
