...
class Invoice(Base):
    ...
    status: Mapped[InvoiceStatusEnum] = mapped_column(default=InvoiceStatusEnum.DRAFT, server_default="DRAFT")
...
class InvoiceItem(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, server_default=text("gen_random_uuid()"))
    invoice_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("catalog.invoices.id", ondelete="CASCADE"))
